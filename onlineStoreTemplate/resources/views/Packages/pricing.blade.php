...
@section('content')
        ...
        <table class="table1  ">
            ...
            @if(!\Illuminate\Support\Facades\Auth::guest())
                @if(\Illuminate\Support\Facades\Auth::user()->role < 2)
                    <tr>
                        <td colspan="6" style="width:90.55pt;border-top:none;border-left:solid windowtext 1.0pt;border-bottom:none;border-right:solid windowtext 1.0pt;background:  #e4002b50;padding:0cm 5.4pt 0cm 5.4pt;">
                            <p style='margin-top:0cm;margin-right:0cm;margin-bottom:.0001pt;margin-left:0cm;line-height:normal;font-size:15px;font-family:"Calibri","sans-serif";text-align:center;'><strong><span style="font-size:16px;color:#e4002b;">Get 30-Days sponsorship on our website slideshow your property for Adiitional $ 99 ONLY!</span></strong></p>
                        </td>
        ...
        <table class="table1  ">
            ...
            <tr>
                ...
                <td style="width:75.0pt;border-top:none;border-left:none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;padding:0cm 5.4pt 0cm 5.4pt;height:15.75pt;">
                    <p style='margin-top:0cm;margin-right:0cm;margin-bottom:.0001pt;margin-left:0cm;line-height:normal;font-size:15px;font-family:"Calibri","sans-serif";text-align:center;'><span style='font-size:11px;font-family:"Arial","sans-serif";color:#333333;'>&nbsp;</span></p>
                </td>
    ...
    <div class="container bg-white p-5" style="overflow-x: scroll;" id="Commercial_Sale">
        ...
        <table class="table1">
            ...
            <tbody>
            <tr>
                <td colspan="4" style="width:293.85pt;border:solid windowtext 1.0pt;background:#f2f2f2;padding:0cm 5.4pt 0cm 5.4pt;height:29.25pt;">
            ...
            @if(!\Illuminate\Support\Facades\Auth::guest())
                @if(\Illuminate\Support\Facades\Auth::user()->role < 2)
                    <tr>
                        <td colspan="4" style="width:90.55pt;border-top:none;border-left:solid windowtext 1.0pt;border-bottom:none;border-right:solid windowtext 1.0pt;background:  #e4002b50;padding:0cm 5.4pt 0cm 5.4pt;">
                            <p style='margin-top:0cm;margin-right:0cm;margin-bottom:.0001pt;margin-left:0cm;line-height:normal;font-size:15px;font-family:"Calibri","sans-serif";text-align:center;'><strong><span style="font-size:16px;color:#e4002b;">Get 30-Days sponsorship on our website slideshow your property for Adiitional $ 99 ONLY!</span></strong></p>
                        </td>
    ...
    <div class="container bg-white p-5" style="overflow-x: scroll;" id="Commercial_Rent">
        ...
        <table class="table1  ">
            ...
            <tbody>
            <tr>
                <td colspan="4" style="width:299.85pt;border:solid windowtext 1.0pt;background:#f2f2f2;padding:0cm 1.5pt 0cm 1.5pt;height:28.3pt;">
        ...
        <table class="table1  ">
            ...
            <tr>
                <td style="width:216.7pt;border:solid windowtext 1.0pt;border-top:  none;background:#f2f2f2;padding:0cm 1.5pt 0cm 1.5pt;height:30.5pt;">
                    <p style='margin-top:0cm;margin-right:0cm;margin-bottom:.0001pt;margin-left:0cm;line-height:normal;font-size:15px;font-family:"Calibri","sans-serif";text-align:center;'><strong><span style="font-size:16px;color:#e4002b;">Add up 33 photos of your property</span></strong></p>
                </td>
                <td style="width:80.55pt;border-top:none;border-left:none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;padding:0cm 1.5pt 0cm 1.5pt;height:  30.5pt;">
                    <p style='margin-top:0cm;margin-right:0cm;margin-bottom:.0001pt;margin-left:0cm;line-height:normal;font-size:15px;font-family:"Calibri","sans-serif";text-align:center;'><span style='font-size:11px;font-family:"Arial","sans-serif";color:#333333;'>X</span></p>
                </td>
